...
!function (t, e) {
    ...
    return function (t) {
        ...
        function __webpack_require__(r) {
            ...
            return t[r].call(a.exports, a, a.exports, __webpack_require__),
                a.l = !0,
                a.exports
        }
        ...
        function hash_serializer(t, e, r) {
            if (e.match(i)) {
                !function hash_assign(t, e, r) {
                    ...
                    if ("[]" === a)
                        return t = t || [],
                            Array.isArray(t) ? t.push(hash_assign(null, e, r)) : (t._values = t._values || [],
        ...
        t.exports = function (t, e) {
            ...
            for (var r = e.hash ? {} : "", i = e.serializer || (e.hash ? hash_serializer : str_serialize), s = t && t.elements ? t.elements : [], c = Object.create(null), l = 0; l < s.length; ++l) {
                ...
                if ((e.disabled || !u.disabled) && u.name && (o.test(u.nodeName) && !n.test(u.type))) {
                    var d = u.name
                        , f = u.value;
                    if ("checkbox" !== u.type && "radio" !== u.type || u.checked || (f = void 0),
                        e.empty) {
                        if ("checkbox" !== u.type || u.checked || (f = ""),
                    ...
                    if ("select-multiple" !== u.type)
                        ...
                        for (var h = u.options, y = !1, p = 0; p < h.length; ++p) {
                            var m = h[p]
                                ...
                                , _ = m.value || v;
                            m.selected && _ && (y = !0,
                                r = e.hash && "[]" !== d.slice(d.length - 2) ? i(r, d + "[]", m.value) : i(r, d, m.value))
                        }
                        !y && e.empty && (r = i(r, d, ""))
                    }
                }
        ...
        , function (t, e, r) {
            ...
            function Headers(t) {
                this.map = {},
                    t instanceof Headers ? t.forEach((function (t, e) {
                        this.append(e, t)
                    }
            ...
            function Body() {
                return this.bodyUsed = !1,
                    this._initBody = function (t) {
                        var e;
                        this._bodyInit = t,
                            t ? "string" === typeof t ? this._bodyText = t : n.blob && Blob.prototype.isPrototypeOf(t) ? this._bodyBlob = t : n.formData && FormData.prototype.isPrototypeOf(t) ? this._bodyFormData = t : n.searchParams && URLSearchParams.prototype.isPrototypeOf(t) ? this._bodyText = t.toString() : n.arrayBuffer && n.blob && ((e = t) && DataView.prototype.isPrototypeOf(e)) ? (this._bodyArrayBuffer = bufferClone(t.buffer),
                                this._bodyInit = new Blob([this._bodyArrayBuffer])) : n.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(t) || i(t)) ? this._bodyArrayBuffer = bufferClone(t) : this._bodyText = t = Object.prototype.toString.call(t) : this._bodyText = "",
            ...
            function fetch(t, e) {
                return new Promise((function (r, a) {
                    ...
                    if (o.signal && o.signal.aborted)
                        return a(new l("Aborted", "AbortError"));
                    ...
                    (e = [{
                        ...
                        value: function (t, e) {
                            this.cartItemCount(t),
                                this.isDrawerMode ? 0 === t.item_count ? (this.renderBlankCartDrawer(),
                                    this.cartDrawerFooter.classList.add("is-invisible")) : (this.renderDrawerCart(t),
                                        this.cartDrawerFooter.classList.remove("is-invisible"),
                                        "function" === typeof e && e(t)) : 0 === t.item_count ? (this.renderBlankMiniCart(),
                                            this.cartMiniCartFooter.classList.add("is-invisible")) : (this.renderMiniCart(t),
                        ...
                        value: function (t) {
                            ...
                            this.clearCartDrawer(),
                                t.items.forEach((function (t, r) {
                                    ...
                                    null === a && (a = "");
                                    var n = '\n        <div class="go-cart-item__single" data-line="'.concat(Number(r + 1), '">\n            <div class="go-cart-item__info-wrapper">\n                <div class="go-cart-item__image" style="background-image: url(').concat(t.image, ');"></div>\n                <div class="go-cart-item__info">\n                    <a href="').concat(t.url, '" class="go-cart-item__title">').concat(t.product_title, '</a>\n                    <div class="go-cart-item__variant">').concat(a, '</div>\n                    <div class="go-cart-item__quantity order__1">\n                        <span class="go-cart-item__quantity-label">Količina: </span>\n                        <span class="go-cart-item__quantity-button js-go-cart-quantity-minus">-</span>\n                        <input class="go-cart-item__quantity-number js-go-cart-quantity" type="number" value="').concat(t.quantity, '" disabled>\n                        <span class="go-cart-item__quantity-button js-go-cart-quantity-plus">+</span>\n                    </div>\n                </div>\n            </div>\n            <div class="go-cart-item__price order__2">').concat(formatMoney(t.line_price, e.moneyFormat), '</div>\n            <a class="go-cart-item__remove ').concat(e.removeFromCartNoDot, '">Izbacite</a>\n        </div>\n      ');
                                ...
                                document.querySelectorAll(this.itemQuantityMinus).forEach((function (t) {
                                    t.addEventListener("click", (function () {
                                        var r = t.parentNode.parentNode.parentNode.parentNode.getAttribute("data-line")
                                            , a = Number(t.parentNode.querySelector(e.itemQuantity).value) - 1;
                                        e.changeItemQuantity(r, a),
                                            0 === Number(t.parentNode.querySelector(e.itemQuantity).value - 1) && GoCart.removeItemAnimation(t.parentNode.parentNode.parentNode.parentNode)
                                    }
                                    ))
                                }
                                ))
                        ...
                        value: function () {
                            this.cartDrawerSubTotal.parentNode.classList.add("is-invisible"),
                                this.clearCartDrawer(),
                                this.cartDrawerContent.innerHTML = '<div class="go-cart__empty">Vaša korpa je prazna!</div>'
                        }
                    }, {
